...
namespace TemperatureWebpage.Migrations
{
    ...
    [Migration("20200504114420_Alexander")]
            ...
            modelBuilder.Entity("TemperatureWebpage.Models.WeatherObservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LocationRefId = 1,
                            Temperature = 20.0,
                            TimeOfDay = new DateTime(2020, 5, 4, 13, 44, 20, 214, DateTimeKind.Local).AddTicks(2462)
                        },
                        new
                        {
                            ...
                            LocationRefId = 1,
                            Temperature = 55.0,
                            TimeOfDay = new DateTime(2020, 5, 4, 13, 44, 20, 217, DateTimeKind.Local).AddTicks(2776)
                        });
                });
