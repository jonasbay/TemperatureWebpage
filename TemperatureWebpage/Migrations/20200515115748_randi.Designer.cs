...
namespace TemperatureWebpage.Migrations
{
    ...
    [Migration("20200515115748_randi")]
    partial class randi
    {
            ...
            modelBuilder.Entity("TemperatureWebpage.Models.DTOUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Default",
                            PasswordHash = "$2a$11$smyU1UZDV6KOAh/XPGyVyexwl4i5My1vW0Ts2mkgML7YXuId7RTiy"
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Name = "Alex",
                            PasswordHash = "$2a$11$oJZ06qB.a6CcM/ajjfv7T.qarL7ce5PUXkkKE44ez72cSnh8JzW6q"
                        });
                });
