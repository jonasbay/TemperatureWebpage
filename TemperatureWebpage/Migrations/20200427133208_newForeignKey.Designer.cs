...
namespace TemperatureWebpage.Migrations
{
    ...
    [Migration("20200427133208_newForeignKey")]
            ...
            modelBuilder.Entity("TemperatureWebpage.Models.WeatherObservation", b =>
                {
                    ...
                    b.Property<string>("LocationRefName")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LocationRefName = "USA",
                            Temperature = 20.0,
                            TimeOfDay = new DateTime(2020, 4, 27, 15, 32, 8, 618, DateTimeKind.Local).AddTicks(6365)
                        });
                });
