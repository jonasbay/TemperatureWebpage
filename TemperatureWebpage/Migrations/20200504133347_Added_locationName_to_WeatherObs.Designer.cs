...
namespace TemperatureWebpage.Migrations
{
    ...
    [Migration("20200504133347_Added_locationName_to_WeatherObs")]
    partial class Added_locationName_to_WeatherObs
    {
            ...
            modelBuilder.Entity("TemperatureWebpage.Models.WeatherObservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LocationRefId = 1,
                            Temperature = 20.0,
                            TimeOfDay = new DateTime(2020, 5, 4, 15, 33, 46, 704, DateTimeKind.Local).AddTicks(4310)
                        },
                        new
                        {
                            ...
                            LocationRefId = 1,
                            Temperature = 40.0,
                            TimeOfDay = new DateTime(2020, 5, 4, 15, 33, 46, 707, DateTimeKind.Local).AddTicks(8073)
                        },
                        new
                        {
                            ...
                            LocationRefId = 1,
                            Temperature = 23.0,
                            TimeOfDay = new DateTime(2020, 5, 4, 15, 33, 46, 707, DateTimeKind.Local).AddTicks(8135)
                        },
                        new
                        {
                            ...
                            LocationRefId = 1,
                            Temperature = 55.0,
                            TimeOfDay = new DateTime(2020, 5, 4, 15, 33, 46, 707, DateTimeKind.Local).AddTicks(8139)
                        });
                });
